    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=255, verbose_name='비밀 번호')),
                ('name', models.CharField(max_length=255, verbose_name='이름')),
                ('role', models.CharField(choices=[('ADMIN', '어드민'), ('COMPANY', '기업 고객')], default='company', max_length=10, verbose_name='역할')),
                ('is_staff', models.BooleanField(default=False, verbose_name='어드민 사용자 여부')),
